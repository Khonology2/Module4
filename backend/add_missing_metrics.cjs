...
async function addMetricsToExistingSprints() {
  try {
    ...
    for (const sprint of sprintsWithoutMetrics.rows) {
      try {
        // Add default metrics for this sprint
        await pool.query(`
        ...
        `, [
          sprint.id,           // sprint_id
          20,                  // planned_points (default)
          18,                  // committed_points (default)
          0,                   // completed_points (default for new sprints)
          0,                   // carried_over_points (default)
          0.0,                 // test_pass_rate (default)
          0.0,                 // code_coverage (default)
          0,                   // escaped_defects (default)
          0,                   // defects_opened (default)
          0,                   // defects_closed (default)
          0.0,                 // code_review_completion (default)
          'pending',           // documentation_status (default)
          '',                  // uat_notes (default empty)
          0.0,                 // uat_pass_rate (default)
          '',                  // risks (default empty)
          '',                  // blockers (default empty)
          ''                   // decisions (default empty)
        ]);
